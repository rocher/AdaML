...
:END:
_=UML=_
#+begin_src plantuml :file fig-types-range-types.eps
!include AdaML.puml
...
#+RESULTS:
[[file:fig-types-range-types.eps]]
...
:END:
_=UML=_
#+begin_src plantuml :file fig-types-modular-types.eps
!include AdaML.puml
...
[[file:fig-types-modular-types.eps]]
...
:END:
_=UML=_
#+begin_src plantuml :file fig-types-enumeration-types.eps
!include AdaML.puml
...
[[file:fig-types-enumeration-types.eps]]
...
:END:
_=UML=_
#+begin_src plantuml :file fig-types-record-types.eps
!include AdaML.puml
begin_type("Foo_Type")
  function("Answer", "", "Natural")
...
[[file:fig-types-record-types.eps]]
...
:END:
_=UML=_
#+begin_src plantuml :file fig-types-record-types-discriminant.eps
!include AdaML.puml
begin_type("Activity_Plan<Day : Day_Type>")
  attribute("Exercise", "Float := 0.75")
  case("Day is Mon..Fri")
...
#+RESULTS[5c1d589e39dac08c16326372d2ada6331a1129b0]:
[[file:fig-types-record-types-discriminant.eps]]
...
:END:
_=UML=_
#+begin_src plantuml :file fig-types-derived-types.eps
!include AdaML.puml
type_new("Integer", "Foo_Type")
begin_type_new("Integer", "Bar_Type")
  range("-1 .. 20")
...
[[file:fig-types-derived-types.eps]]
